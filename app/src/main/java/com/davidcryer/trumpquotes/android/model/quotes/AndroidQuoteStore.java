...
public class AndroidQuoteStore extends SQLiteOpenHelper implements QuoteStore {

    public AndroidQuoteStore(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
